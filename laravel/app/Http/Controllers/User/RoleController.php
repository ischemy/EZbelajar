...
//            ->with('i', ($request->input('page', 1) - 1) * 5);
    ...
    public function create()
    {
        ...
        return view('pages.Dashboard.user.roles.create',compact('permission'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.Dashboard.user.roles.show',compact('role','rolePermissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.Dashboard.user.roles.edit',compact('role','permission','rolePermissions'));
    }
