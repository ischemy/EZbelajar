<section class="">
    <div class="navbar-1-1" style="font-family: 'Poppins', sans-serif">
        <div class=" mx-auto flex flex-wrap flex-row items-center justify-between py-5">

            <a href="{{ route('index') }}" class="items-center">
                <img src="{{ asset('assets/images/logo.svg') }}" alt="Logo" class=" pl-10 w-25 h-10">
            </a>
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a href="{{ route('banksoal.index') }}"
                       class="block {{ request()->is('banksoal') ? 'nav-link active font-medium': ''}}">Bank Soal</a>
                    ...
                    @auth
                        ...
                        @can('dashboard-access')
                            <a href="{{ route('admin.dashboard.index') }}" class="block lg:hidden nav-link text-ezb-text">Dashboard</a>
                        @endcan
                        ...
                        {{--                           href="{{ route('admin.profile.index') }}">Edit Profile</a>--}}

                        <a href="{{ route('logout') }}" class="block lg:hidden nav-link text-ezb-text" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout
            ...
            @guest
                <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
                    ...
                    <button onclick="toggleModal('registerModal')"
                            class="lg:bg-ezb-services-bg text-ezb-regis-text items-center border-0 block lg:inline-block  lg:py-3 lg:px-10 focus:outline-none rounded-2xl font-medium text-base mt-6 lg:mt-0 text-white">
                        Daftar
                    </button>
                </div>
            @endguest
            ...
            {{--                            <a href="{{ route('dashboard') }}" class="block lg:hidden nav-link text-ezb-text">Dashboard</a>--}}
            ...
            @auth
                <div @click.away="open = false" class="hidden lg:block relative pr-10" x-data="{ open: false }">
...
{{--    {{ route('member.dashboard.index') }} --}}
{{--    {{ route('edit.profile.navbar.pages') }}--}}
