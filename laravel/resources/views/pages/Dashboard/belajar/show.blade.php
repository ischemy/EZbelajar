    ...
    <main class="h-full overflow-y-auto">
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <p class="font-medium">Show Belajar</p>
                </li>
            </ol>
        </nav>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            <label for="title" class="block mb-3 font-medium text-gray-700 text-md">Title</label>
                                                <p class="text-sm text-gray-600">{{ $belajar->title }}</p>
                                        </div>
                                        ...
                                        <div class="col-span-6">
                                            <label for="link" class="block mb-3 font-medium text-gray-700 text-md">Link</label>
                                                <p class="text-sm text-gray-600">{{ $belajar->link }}</p>
                                        </div>
                                    </div>
                                </div>

                                <div class="px-4 py-3 text-right sm:px-6">
                                    <a href="{{ route('admin.belajar.index') }}" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300">
                                        Back
                                    </a>
