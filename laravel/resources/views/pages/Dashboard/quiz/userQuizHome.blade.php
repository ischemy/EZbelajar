...
<div class="container px-6 mx-auto mt-5">
    ...
    <div class="container mx-auto">
        <div class="grid w-full mx-auto md:grid-cols-12">
            <div class="col-span-4">
                <h2 class="mt-8 mb-1 text-2xl font-semibold text-gray-700">
                Quiz
                </h2>
                <p clxass="text-sm text-gray-400">
                {{ auth()->user()->bank_soal()->count() }} Total Quiz
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="flex flex-wrap -m-4 text-center">
                        <div class="p-4 sm:w-1/2">
                            <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                ...
                                <h2 class="title-font font-medium text-xl text-gray-900">{{$banksoals->count()}}</h2>
                                <p class="leading-relaxed">Quiz</p>
                            </div>
                        </div>
                        <div class="p-4 sm:w-1/2">
                            <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                    ...
                                    @foreach($userQuizzes as $quiz)
                                        <tr class="hover:bg-green-100">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="ml-4">
                                                        <div class="text-sm font-medium text-gray-900">
                                                            <a class="text-white px-6 font-extrabold py-1 rounded-lg bg-blue-500 hover:bg-blue-600 hover:underline" href="{{route('admin.userQuizDetails', $quiz->id)}}">
                                                                {{ $quiz->quiz_size}}
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="sm:flex align-middle justify-center items-center px-6 py-1 text-right text-sm font-medium">
                                                <a href="{{route('admin.userQuizDetails', $quiz->id)}}" class="text-green-500 hover:text-green-700">
                                                ...
                                                <form action="{{route('admin.deleteUserQuiz', $quiz->id)}}" method="post">
                                                    @csrf
