...
{{--                    </g>--}}
{{--                </svg>--}}
                <img src="{{ asset('assets/logo.png') }}" alt="logo" class="w-32" viewBox="0 0 84 21" preserveAspectRatio="xMinYMin meet" version="1.1" focusable="false">
            </div>

            <!-- Layout  -->
            <div class="bg-white w-96 shadow-xl rounded p-5 items-center">
                <h1 class="text-3xl font-medium text-center">RESET PASSWORD</h1>
                <form class="space-y-5 mt-5" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input name="email" value="{{ $request->email ?? '' }}" class="appearance-none border border-gray-300 rounded-lg w-80 py-3 px-4 placeholder-ezb-text text-xs" id="email" type="text" placeholder="Email"  required autofocus>
...
{{--                    <input type="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="password" />--}}
{{--                    <input type="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="confirm-password" />--}}


                    <div class="">
                        <input type="hidden" name="auth" value="true">
                        <button class="lg:bg-ezb-services-bg text-white text-lg ml-23 py-3 px-12 my-2 rounded-lg w-36 ml-21" type="submit">Reset<br>
                        </button>
                    </div>
