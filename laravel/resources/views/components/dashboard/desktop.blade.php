...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white md:block" aria-label="aside">
    <div class="text-ezb-bg">
        ...
        <div class="" href="admin.dashboard.index">
        ...
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            <div>
                ...
                <p class="text-sm font-light text-ezb-text">
                                        {{ auth()->user()->detail_user()->first()->occupation ?? '' }}
                </p>
            </div>
        </div>
...
{{--            </li>--}}
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800"
                   href="{{ route('admin.banksoal.index')}}">
                    <!-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800"
                   href="{{ route('admin.artikel.index') }}">
                    ...
                    <img src="{{ asset('/assets/icondashboard/file-text.svg') }}" alt="Artikel">
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800"
                   href="{{ route('admin.bootcamp.index') }}">
                    <!-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" fill="white" />
                        <circle cx="10.5" cy="5.5" r="2.75" stroke="#082431" stroke-width="1.5" />
                        <path d="M3.75 18.2581C3.75 14.6638 6.66376 11.75 10.2581 11.75H11.7419C15.3362 11.75 18.25 14.6638 18.25 18.2581C18.25 18.8059 17.8059 19.25 17.2581 19.25H4.74194C4.1941 19.25 3.75 18.8059 3.75 18.2581Z" stroke="#082431" stroke-width="1.5" />
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('admin.profile.index') }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" fill="white" />
                        <circle cx="10.5" cy="5.5" r="2.75" stroke="#082431" stroke-width="1.5" />
                        <path d="M3.75 18.2581C3.75 14.6638 6.66376 11.75 10.2581 11.75H11.7419C15.3362 11.75 18.25 14.6638 18.25 18.2581C18.25 18.8059 17.8059 19.25 17.2581 19.25H4.74194C4.1941 19.25 3.75 18.8059 3.75 18.2581Z" stroke="#082431" stroke-width="1.5" />
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                @if (request()->is('admin/service') || request()->is('admin/service/*') || request()->is('admin/*/service') || request()->is('admin/*/service/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-ezb-bg"
                        aria-hidden="true"></span>
                @endif
            ...
            <li class="relative px-6 py-3">
                ...
                @if (request()->is('admin/order') || request()->is('admin/order/*') || request()->is('admin/*/order') || request()->is('admin/*/order/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-ezb-bg"
                        aria-hidden="true"></span>
                @endif
