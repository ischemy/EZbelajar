...
<!-- end of quiz box -->
    ...
    @if($showResult)
        <section class="text-gray-600 body-font">
            <div class=" border-2 border-gray-300 shadow overflow-hidden sm:rounded-lg">
                <div class="container px-5 py-5 mx-auto">
                    ...
                    <div class="mx-auto min-w-full p-2 md:flex m-2 justify-between">
                        <a href="{{route('admin.userQuizDetails',$quizid) }}" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">See Quizzes Details</a>
                        <a href="{{route('index')}}" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">See All Your Quizzes</a>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="p-4 md:w-1/2 w-full">
                        <form wire:submit.prevent="startQuiz">
                            ...
                            <div class="relative mx-full mb-4">
                                <select name="bankroll" id="bank_soal_id" wire:model="banksoalId" class="block w-full mt-1 rounded-md bg-gray-100 border-2 border-gray-500 focus:ring-0" required>
...
{{--                                                <option value="{{$banksoal->id}}">{{$banksoal->name}}</option>--}}
                                ...
                                @error('banksoalId') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div class="relative mb-4">
                                <select name="quiz_size" id="quiz_size" wire:model="quizSize" class="max-w-full block w-full mt-1 rounded-md bg-gray-100 border-2 border-gray-500 focus:ring-0">
                                    @for ($i = 1; $i <= 50; $i++) <option value="{{ $i }}">{{ $i }}</option> @endfor
                                </select>
                                @error('quizSize') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                            </div>
                            <button type="submit" class="block w-full text-white lg:bg-ezb-services-bg border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Start Quiz</button>
                        </form>
                    </div>
                </div>
            </div>
...
{{--                            <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Take a Quiz</h2>--}}
{{--                            <div class="relative mx-full mb-4">--}}
{{--                                <select name="banksoal" id="banksoal_id" wire:model="banksoalId" class="block w-full mt-1 rounded-md bg-gray-100 border-2 border-gray-500 focus:bg-white focus:ring-0">--}}
{{--                                    @if($banksoals->isEmpty())--}}
{{--                                        <option value="">No Quiz Sections Available Yet</option>--}}
{{--                                    @else--}}
{{--                                        <option value="">Select a Quiz Section</option>--}}
{{--                                        @foreach($banksoals as $banksoal)--}}
{{--                                            @if($banksoal->questions_count>0)--}}
{{--                                                <option value="{{$banksoal->id == 1}}">Testing</option>--}}
{{--                                                <option value="{{$banksoal->id}}">{{$banksoal->name}}</option>--}}
{{--                                            @endif--}}
{{--                                        @endforeach--}}
{{--                                    @endif--}}
...
{{--                                @error('quizSize') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror--}}
{{--                            </div>--}}
{{--                            <button type="submit" class="block w-full lg:bg-ezb-services-bg text-white border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Start Quiz</button>--}}
{{--                        </form>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
